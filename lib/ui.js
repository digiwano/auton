...
UI.prototype.startup = function( version, env ) {
  ...
  cursor // big thanks to rocket robot for posing for the logo!
    ...
    .yellow().write("  |    ______   |").green().write(                                       envString+" ").cyan().write("|\n")
    .yellow().write("  |   [  @ @ ]  |").white().write("                       _|                         ").cyan().write("|\n")
    .yellow().write("  |  _[___=__]  |").white().write("   _|_|_|  _|    _|  _|_|_|_|    _|_|    _|_|_|   ").cyan().write("|\n")
    .yellow().write("  | [         ] |").white().write(" _|    _|  _|    _|    _|      _|    _|  _|    _| ").cyan().write("|\n")
    .yellow().write("  | [ O=====C ] |").white().write(" _|    _|  _|    _|    _|      _|    _|  _|    _| ").cyan().write("|\n")
    .yellow().write("  | [_,-,_,-,_] |").white().write("   _|_|_|    _|_|_|      _|_|    _|_|    _|    _| ").cyan().write("|\n")
    .yellow().write("  |    O   O    |").white().write("                                                  ").cyan().write("|\n")
    .yellow().write("  x-------------x").cyan( ).write("--------------------------------------------------x\n")
