...
Server.prototype.start          = function( ) { this.process.start();      };
Server.prototype.restart        = function( ) { this.process.restart();    };
Server.prototype.stop           = function( ) { this.process.stop();       };

Server.prototype._serverStart   = function( ) { this.success('started');   };
Server.prototype._serverRestart = function( ) { this.success('restarted'); };
Server.prototype._serverStop    = function( ) { this.info('stopped');      };
Server.prototype._serverExit    = function( ) { this.info('exited');       };
